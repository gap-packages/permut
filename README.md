[![CI](https://github.com/gap-packages/permut/actions/workflows/CI.yml/badge.svg)](https://github.com/gap-packages/permut/actions/workflows/CI.yml)
...
to load it.
GAP 4.11.0 or later is required.
